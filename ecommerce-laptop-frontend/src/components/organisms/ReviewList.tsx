...
export const ReviewList: React.FC<ReviewListProps> = ({
    ...
    const openReviewForm = () => {
        if (isAuthenticated) {
            ...
            alert('Vui lng ng nhp  vit nh gi');
        }
    };
                            ...
                            <div className="absolute right-0 top-12 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-10 min-w-[240px]">
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        >
                                            <option value="CreatedAt-DESC">Mi nht</option>
                                            <option value="CreatedAt-ASC">C nht</option>
                                            <option value="Rating-DESC">im cao nht</option>
                                            <option value="Rating-ASC">im thp nht</option>
                                        </select>
                                    </div>
            ...
            {reviews && reviews.reviews.length > 0 ? (
                ...
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-4">
                        Hy l ngi u tin nh gi sn phm ny
                    </p>
                    {isAuthenticated && summary?.canUserReview && (
                        <button
                            onClick={openReviewForm}
