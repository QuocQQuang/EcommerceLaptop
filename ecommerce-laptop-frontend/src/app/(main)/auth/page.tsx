            ...
            >
                ...
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="bg-[#111] border border-[#333] rounded-2xl shadow-2xl shadow-[#00f5d4]/10 backdrop-blur-sm p-0"
                    >
                        {mode === 'login' ? (
                            <LoginForm onSuccess={handleSuccess} callbackUrl={callbackUrl} />
                        ) : (
                ...
                >
                    <Button
                        type="button"
                        variant="ghost"
                        className="text-[#9ca3af] hover:text-[#00f5d4] p-0 h-auto"
                        onClick={toggleMode}
                    >
                        {mode === 'login'
                            ? "Cha c ti khon? ng k"
