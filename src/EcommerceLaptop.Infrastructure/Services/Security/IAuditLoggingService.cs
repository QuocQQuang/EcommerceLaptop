...
public interface IAuditLoggingService
{
    ...
    Task<ServiceResult<List<SystemAuditLog>>> GetUserAuditLogsAsync(int userId, DateTime? from = null, DateTime? to = null, int page = 1, int pageSize = 50);
    Task<ServiceResult<List<SystemAuditLog>>> GetAdminAuditLogsAsync(int? adminId = null, DateTime? from = null, DateTime? to = null, int page = 1, int pageSize = 50);
    Task<ServiceResult<List<SystemAuditLog>>> SearchAuditLogsAsync(string? activity = null, string? ipAddress = null, DateTime? from = null, DateTime? to = null, int page = 1, int pageSize = 50);
